...
export const sports: Sport[] = [
  ...
  },
  {
    ...
    longDescription: "Effective teaching program We follow the proven and effective PADI (Professional Association of Diving Instructors) methodology. We aim to be efficient, fun, healthy and safe. We uphold sportsmanship and approach diving with scientific rigor. We will stimulate your child's interest in diving with a lively and interesting teaching method, train your child's diving skills in a serious and responsible manner, and cultivate your child's respect and love for nature through a hands-on experience. Professional coaching team Our coaches are from PADI, they have received rigorous training, have a high professional level, and they love children and love coaching work, they will teach with enthusiasm and a serious and responsible attitude. Excellent diving experience In addition to indoor diving training, we will also have outdoor field diving. The waters we choose for diving will be beautiful, pollution-free and safe. Comfortable water temperature and water pressure, amazingly beautiful landscapes, and fascinating biodiversity will give your children a wonderful, comfortable and unforgettable diving experience Concerned and Guaranteed Safety For a passionate outdoor sport, safety has always been our priority. Our staff are trained in safety and medical first aid, and our facilities are strictly enforced to the highest level of safety standards, from pre-training to field experience, we will provide you with a safe training environment.",
    image: {
