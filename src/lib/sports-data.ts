...
export const sports: Sport[] = [
  ...
  },
  {
    ...
    longDescription: "YES Basketball program focuses on student’s development as basketball players and individuals. Students get acces to 3 type of trainings:\n\n•SKILLS DEVELOPMENT TRAINING\nSkills development training enchances student’s abilities to perform and grow individually with more confidence.\n\n•TEAM TRAINING\nTeam training enhances the ability to create chemistry allowing the team to perform collectively on offense and defense.\n\n•STRENGTH TRAINING\nStrenght training enhances student’s athletic abilities to perform at a high intensity longer with focus.\n\nYES Basketball principles aim towards leadership, resilience, discipline and courage. These are important values that each student will need in the futur.",
    image: {
