          ...
          <p className="text-center mt-4 text-muted-foreground max-w-2xl mx-auto">
           ...
           <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
              <div className="rounded-lg border p-6">
                <h3 className="text-xl font-semibold">{t('locations.shanghai.name')}</h3>
                <div className="mt-4 space-y-2 text-muted-foreground">
                  <p className="flex items-center justify-center"><MapPin className="mr-2 h-4 w-4" /> {t('locations.shanghai.address')}</p>
                  <p className="flex items-center justify-center"><Phone className="mr-2 h-4 w-4" /> {t('locations.shanghai.phone')}</p>
                  <p className="flex items-center justify-center"><Mail className="mr-2 h-4 w-4" /> {t('locations.shanghai.email')}</p>
                </div>
              </div>
